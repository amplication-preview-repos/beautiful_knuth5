...
@InputType()
class AttachmentCreateNestedManyWithoutTicketsInput {
...
export { AttachmentCreateNestedManyWithoutTicketsInput as AttachmentCreateNestedManyWithoutTicketsInput };
